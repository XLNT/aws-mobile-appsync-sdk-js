...
) => withGraphQL(reactMutator(mutation, cacheUpdateQuery, typename, idField, operationType));
...
const reactMutator = (
  ...
  props: props => {
    ...
    const mutationName = resultKeyNameFromField((mutation.definitions[0] as OperationDefinitionNode)
      .selectionSet.selections[0] as FieldNode);

    return {
      [mutationName]: variables =>
        props.mutate(buildMutation(
          client,
          mutation,
          variables,
          cacheUpdateQuery,
